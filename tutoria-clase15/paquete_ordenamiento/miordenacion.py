...
#Dado el siguiente archivo, utilizar una clase para representar cada linea del archivo, luego utilizar unicamente el atributo que represente la edad por cada objeto para almacenar en una lista
#Finalmente utlizar el algoritmo de combinacion para almacenar dichas edades.
